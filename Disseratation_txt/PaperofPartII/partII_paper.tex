...
Cross-scene evaluation on a geographically disjoint southwestern US test region shows that LUSI regularization improves pixel-scale generalization on the new scene, although granule-scale evaluation reveals a robustness-vs-accuracy tradeoff rather than uniform improvement.
\end{abstract}
