...
\node[attn, above=16mm of E]        (score) {Score: $\mathbf{K}\mathbf{q}_h/\sqrt{d}\ +\ \bm{\beta}_h$};
...
\node[loss, fill=yellow!45, above=5mm of ce]  (total){$\mathcal{L}_{\text{total}} = \mathcal{L}_{\text{CE}} + \lambda_{\text{LUSI}}\,\mathcal{L}_{\text{LUSI}}$};
