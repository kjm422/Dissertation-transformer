...
\caption{End-to-end architecture overview. Optional physics-informed components (yellow, dashed) --- spectral priors and LUSI consistency regularization --- can be toggled independently.}
...
\hline
1. Local feature extraction & Tsai \& Philpot \cite{tsai1998derivative}: derivative analysis of hyperspectral data & Shape-aware tokenization \\
 & & (first/second finite differences as local spectral features) \\
\hline
2. Positional encoding & Vaswani et al.\ \cite{vaswani2017attention}: token position & Learnable band-position embedding \\
\hline
...
\begin{itemize}
  ...
  \item \textbf{Local-then-global processing:} Shape-aware tokenization extracts local spectral features --- first and second finite differences along the wavelength axis, in the spirit of derivative analysis of hyperspectral data \cite{tsai1998derivative} --- before the transformer evaluates global context, ensuring tokens encode absorption morphology prior to attention.
